    ...
    return (
      <>
        <Head> {/* 메타데이터 */ }
          ...
          <meta name="theme-color" content="#000000" /> {/* 구글 검색시 출력되는 title과 description */}
          <meta
            name="description"
          ...
          <Fragment>
            ...
            <div className="short_review_box">
              ...
              <div className="review_box">
                <img className="review_img" src="https://main.redate.co.kr/organism/Letter/teacher_19.png"></img>
